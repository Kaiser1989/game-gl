...
BlendBarrier: FnPtr::new(metaloadfn("glBlendBarrier", &["glBlendBarrierKHR", "glBlendBarrierNV"])),
...
PrimitiveBoundingBox: FnPtr::new(metaloadfn("glPrimitiveBoundingBox", &["glPrimitiveBoundingBoxARB", "glPrimitiveBoundingBoxEXT", "glPrimitiveBoundingBoxOES"])),
